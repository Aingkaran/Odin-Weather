...
fetch('http://api.openweathermap.org/geo/1.0/direct?q='+locationset+'&limit=5&appid=eaae588901936a4177510a9a9982cbfe')
  .then(function (response) {
    ...
    async function getWeatherData(latitude, longitude) {
        const response = await fetch('https://api.openweathermap.org/data/2.5/weather?lat='+latitude+'&lon='+longitude+'&appid=eaae588901936a4177510a9a9982cbfe&units=metric');
